    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        if (call.method.equals("getPlatformVersion")) {
            ...
            if (obdAction.equals(ACTION_CONNECTION_STATUS_MSG)) {
                ...
                TripRecord tripRecord = TripRecord.getTripRecode(context);
                if (tripRecord.getmEngineCoolantTemp() != null) {
                    obdEngineCoolantTemp = String.valueOf(tripRecord.getmEngineCoolantTemp());
            ...
            if (obdAction.equals(ACTION_READ_OBD_REAL_TIME_DATA)) {
                ...
                if (tripRecord.getmVehicleIdentificationNumber() != null) {
                    obdVinCode = String.valueOf(tripRecord.getmVehicleIdentificationNumber()); //display speed
                } else {
                    obdVinCode = "no vin code signal";
                }
            }
            result.success("" + obdVinCode);
